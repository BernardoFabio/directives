...
@Component({
  selector: 'app-fondo-empleados-dialog',
  templateUrl: './fondo-empleados-dialog.component.html',
  styleUrls: ['./fondo-empleados-dialog.component.css']
})
export class FondoEmpleadosDialogComponent {
